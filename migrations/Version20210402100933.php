 ...
 */
final class Version20210402100933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_A60C9F1FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livraison DROP FOREIGN KEY FK_A60C9F1FFB88E14F');
