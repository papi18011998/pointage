 ...
 */
final class Version20210324104607 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depart ADD vehicule_id INT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depart DROP vehicule_id');
    }
}
